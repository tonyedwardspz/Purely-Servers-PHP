...
// sql to rerieve the list of unauthorised users
$sqlGetUnauthorisedUsers = "SELECT u.first_name,
                            ...
                            ON u.school = f.ID
                            WHERE u.authorised = '0'";

// sql to update a user to authorised
...
// updated the selected users after selecting one
if (isset($_POST['submit'])){
    $user = $_POST['submit'];
    updateUserSatus($user, $db, $sqlUpdateUser);
}
?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Authorise users</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                                ...
                                                <tr class="gradeA <?php echo $rowColor; ?>">
                                                    ...
                                                    <td class="center ">
                                                        <form action="" method="post">
                                                            ...
                                                            value="<?php echo $row['9']; ?>">Authorise</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            <?php } ?>
