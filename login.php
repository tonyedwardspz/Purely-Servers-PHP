...
// 3rd party solution used to keep under the self allocated time allocated limit
...
class OneFileLoginApplication
{
    ...
    private function showPageLoginForm()
    {
        ...
        echo '</div>';
        echo '<button name="login" value="Log in" type="login" class="btn btn-default">Log in</button>';
        echo '</fieldset></form>';
